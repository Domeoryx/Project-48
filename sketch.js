...
var gameended;
var competitionImg1,competitionImg2,competitionImg3,competitionImg4;
var backgroundImg;
...
competitionImg1 = loadAnimation("ghost1.png");
competitionImg2 = loadAnimation("ghost2.png");
competitionImg3 = loadAnimation("ghost3.png");
competitionImg4 = loadAnimation("ghost4.png");
coinS = loadSound("coin.wav");
gameS = loadSound("Blazer Rail.wav");
runningAnimation = loadAnimation("running1.png","running2.png","running3.png");
gameended = loadAnimation("running1.png");
}
...
function setup() {
  ...
  competition1.addAnimation("test1",competitionImg1);
  competition1.scale = 0.05;
 ...
 competition2.addAnimation("test2",competitionImg2);
 competition2.scale = 0.05;
  competition2.velocityX = -4;
  competition2.velocityY = +4;
  

  competition3 = createSprite(1000,400,20,20);
  competition3.addAnimation("test3",competitionImg3);
  competition3.scale = 0.05;
  competition3.velocityX = -4;
  competition3.velocityY = +4;
  

  competition4 = createSprite(970,100,20,20);
  competition4.addAnimation("test4",competitionImg4);
  competition4.scale = 0.05;
  ...
  student.addAnimation("running",runningAnimation);
  student.scale=0.045
...
function draw() {
  ...
  for (var i = 0; i < coinGroup.length; i++) {
   ...
   if(score>=60 && student.collide(job)){
     textSize(50);
     fill("blue");
     text("U got the job",600,325);
     student.velocityX = 0;
     student.velocityY = 0;
     competitionGroup.setVelocityXEach(0);
     competitionGroup.setVelocityYEach(0);
     student.stopAnimation("stop",runningAnimation);
   }
